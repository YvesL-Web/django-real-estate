...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name =_("Phone Number"), max_length=30, default="+4918745258010")
    ...
    country = CountryField(verbose_name=("Country"),default="GE", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Bochum", blank=False, null=False)
